...
class Pelanggan extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/agen/pelanggan/index', $data);
    }
    ...
    public function tambah()
    {
        ...
        return view('admin/agen/pelanggan/tambah', $data);
    }
    ...
    public function simpan()
    {
        ...
        return redirect()->to('agen/pelanggan');
    }
    ...
    public function detail($no_pelanggan)
    {
        ...
        return view('admin/agen/pelanggan/detail', $data);
    }
    ...
    public function ubah($no_pelanggan)
    {
        ...
        return view('admin/agen/pelanggan/ubah', $data);
    }
    ...
    public function tagihan($id_penggunaan)
    {
        ...
        return view('admin/agen/pelanggan/tagihan', $data);
    }
    ...
    public function bayar($id)
    {
        ...
        return redirect()->to('agen/pelanggan/detail/' . $id_pelanggan);
    }
}
