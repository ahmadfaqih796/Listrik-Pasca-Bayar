        ...
        ?>
            <tr>
                ...
                <?php if (!$data_penggunaan['status'] == 1) { ?>
                    <td><a href="/agen/pelanggan/tagihan/<?= $data_penggunaan['no_penggunaan'] ?>" style="background-color: red;"><i class="fas fa-money-bill"></i></a></td>
                <?php } else { ?>
                    <td><a href="/agen/pelanggan/tagihan/<?= $data_penggunaan['no_penggunaan'] ?>"><i class="fas fa-money-bill"></i></a></td>
                <?php
                } ?>
