...
<body>
    ...
    if (session()->get('username_agen') == '') {
        ...
        return redirect()->to(base_url('admin/agen/login'));
    }
    ?>
    <nav>
        <div class="menu-icon">
        ...
        <div class="nav-items">
            <li><a href="<?= base_url('agen/beranda') ?>">Beranda</a></li>
            <li><a href="<?= base_url('agen/pelanggan') ?>">Pelanggan</a></li>
            <li><a href="<?= base_url('agen/penggunaan') ?>">Penggunaan</a></li>
            <li><a href="http://localhost/web/CI4/listrik/antrian/">Antrian</a></li>
            <li><a href="<?= base_url('agen/login/logout') ?>">Logout</a></li>
        </div>
        <div class="pengguna">
